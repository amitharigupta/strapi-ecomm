...
const cart = () => {
    ...
    const subTotal = useMemo(() => {
        return cartItems.reduce((acc, itr) => {
            return acc + itr.attributes.price
        }, 0)
    }, [cartItems]);
    ...
    <div className="w-full md:py-20">
        <Wrapper>

            {
                cartItems.length > 0 && (
                    <>
                    <div className="text-center max-auto mt-8 md:mt-0">
                        ...
                        <div className="flex flex-col lg:flex-row gap-12 py-10">
                            ...
                            <div className="flex-[1]">
                                ...
                                <div className="text-sm md:text py-5 border-t mt-5">
                                ...
                                <button className="w-full py-4 rounded-full bg-black text-white text-lg font-medium transition-transform active:scale-95 mb-3 hover:opacity-75 flex items-center gap-2 justify-center" onClick={handlePayment}>
                                    Checkout
                                    {
                                        loading && <img src="/assets/img/spinner.svg" alt="Spinner Logo" /> 
                                    }
                                </button>
                            </div>
                        </div>
            ...
            {cartItems.length < 1 && <div className="flex-[2] flex flex-col items-center pb-[50px] md:-mt-14">
                <Image src={"/assets/img/empty-cart.jpg"} width="300" height={300} className="w-[300px] md:w-[400px]" />
