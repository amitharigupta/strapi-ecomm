    ...
    <div className="flex py-5 gap-3 md:gap-5 border-b">
      ...
      <div className="w-full flex flex-col">
        ...
        <div className="flex items-center justify-between mt-4">
          ...
          <RiDeleteBin6Line onClick={() => { dispatch(removeFromCart({ id: data.id})) }} className="cursor-pointer text-black/[0.5] hover:text-black text-[16px] md:text-[20px]"></RiDeleteBin6Line>
        </div>
      </div>
    </div>
  );
